...
class LLamaAndroid {
    ...
    suspend fun quantize(
        ...
        return withContext(runLoop) {
            quantizeNative(fname_inp, fname_out, ftype_str)
        }
    }

    external fun embedding(context: Long, text: String): FloatArray

    suspend fun embedding(text: String): FloatArray {
        return withContext(runLoop) {
            when (val state = threadLocalState.get()) {
                is State.Loaded -> {
                    embedding(state.context, text)
                }
    ...
    val quantizationOptions = listOf(
        "Q4_0", "Q4_1", "Q5_0", "Q5_1", "IQ2_XXS", "IQ2_XS", "IQ2_S", "IQ2_M", "IQ1_S", "IQ1_M",
        "Q2_K", "Q2_K_S", "IQ3_XXS", "IQ3_S", "IQ3_M", "Q3_K", "IQ3_XS", "Q3_K_S", "Q3_K_M",
        "Q3_K_L", "IQ4_NL", "IQ4_XS", "Q4_K", "Q4_K_S", "Q4_K_M", "Q5_K", "Q5_K_S", "Q5_K_M",
        "Q6_K", "Q8_0", "F16", "F32"
    )
